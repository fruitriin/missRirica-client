  ...
  <MkSpacer :content-max="1200">
    ...
    <div v-if="origin === 'local'">
      <template v-if="tag == null">
        <MkFoldableSection class="_margin" persist-key="explore-pinned-users">
          <template #header
            ><i class="fas fa-bookmark ti-fw" style="margin-right: 0.5em"></i
        ...
        <MkFoldableSection class="_margin" persist-key="explore-popular-users">
          <template #header
            ><i class="fas fa-chart-line ti-fw" style="margin-right: 0.5em"></i
        ...
        >
          <template #header
            ><i class="fas fa-comment-alt ti-fw" style="margin-right: 0.5em"></i
    ...
    <div v-else>
      ...
      <template v-if="tag == null">
        ...
        <MkFoldableSection class="_margin">
          <template #header
            ><i class="fas fa-rocket ti-fw" style="margin-right: 0.5em"></i
