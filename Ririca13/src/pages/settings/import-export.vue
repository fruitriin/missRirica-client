  ...
  <div class="_gaps_m">
    <FormSection first>
      <template #label
        ...
        {{ i18n.ts._exportOrImport.allNotes }}</template
      >
      <MkFolder>
    ...
    <FormSection>
      <template #label
        ...
        {{ i18n.ts._exportOrImport.favoritedNotes }}</template
      >
      <MkFolder>
        <template #label>{{ i18n.ts.export }}</template>
        <template #icon><i class="ti ti-download"></i></template>
    ...
    <FormSection>
      <template #label
        ...
        {{ i18n.ts._exportOrImport.followingList }}</template
      >
      <div class="_gaps_s">
        <MkFolder>
          <template #label>{{ i18n.ts.export }}</template>
    ...
    <FormSection>
      <template #label
        ><i class="ti ti-users"></i>
        {{ i18n.ts._exportOrImport.userLists }}</template
      >
      <div class="_gaps_s">
        <MkFolder>
          <template #label>{{ i18n.ts.export }}</template>
    ...
    <FormSection>
      <template #label
        ...
        {{ i18n.ts._exportOrImport.muteList }}</template
      >
      <div class="_gaps_s">
        <MkFolder>
          <template #label>{{ i18n.ts.export }}</template>
    ...
    <FormSection>
      <template #label
        ><i class="ti ti-user-off"></i>
        {{ i18n.ts._exportOrImport.blockingList }}</template
      >
      <div class="_gaps_s">
        <MkFolder>
          <template #label>{{ i18n.ts.export }}</template>
