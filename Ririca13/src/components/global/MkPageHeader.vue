<template>
  <div
    v-if="show"
    ref="el"
    :class="[$style.root, { [$style.slim]: narrow, [$style.thin]: thin_ }]"
    :style="{ background: bg }"
    @click="onClick"
  >
    ...
    <template v-if="metadata">
      ...
      >
        ...
        <div :class="$style.title">
          ...
          <div
            v-if="narrow && hasTabs"
            :class="[$style.subtitle, $style.activeTab]"
          >
