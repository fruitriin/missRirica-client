    ...
    <MkSpacer :content-max="600" :margin-min="16" :margin-max="32">
      <FormSuspense :p="init">
        <div v-if="tab === 'overview'" class="_gaps_m">
          ...
          <MkInfo v-if="user.username.includes('.')">{{
          ...
          <FormLink v-if="user.host" :to="`/instance-info/${user.host}`">{{
          ...
          <FormSection>
            ...
            <div class="_gaps_m">
              ...
              <MkButton v-if="user.host != null" @click="updateRemoteUser"
        ...
        <div v-else-if="tab === 'moderation'" class="_gaps_m">
          <MkSwitch v-model="suspended" @update:model-value="toggleSuspend">{{
            i18n.ts.suspend
          }}</MkSwitch>
          ...
          <div>
            <MkButton
              ...
              @click="resetPassword"
              ><i class="ti ti-key"></i> {{ i18n.ts.resetPassword }}</MkButton
            >
            <MkButton v-if="$i.isAdmin" inline danger @click="deleteAccount">{{
