      ...
      <div v-if="tab === 'overview'" class="_gaps_m">
        ...
        <FormSection v-if="iAmModerator">
          ...
          <div class="_gaps_s">
            ...
            <MkSwitch v-model="isBlocked" @update:model-value="toggleBlock">{{
              i18n.ts.blockThisInstance
            }}</MkSwitch>
            <MkButton @click="refreshMetadata"
              ><i class="ti ti-refresh"></i> Refresh metadata</MkButton
            >
          </div>
        </FormSection>
        ...
        <FormSection>
          <MkKeyValue oneline style="margin: 1em 0">
            ...
            <template #value
              ><MkTime mode="detail" :time="instance.firstRetrievedAt"
            /></template>
          </MkKeyValue>
          <MkKeyValue oneline style="margin: 1em 0">
