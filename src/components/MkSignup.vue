    ...
    >
      <template #label
        ...
        <div v-tooltip:dialog="i18n.ts.usernameInfo" class="_button _help">
          <i class="ti ti-question-circle"></i></div
      ></template>
      ...
      <template #caption>
        ...
        <span v-else-if="usernameState === 'error'" style="color: var(--error)"
          ><i class="ti ti-alert-triangle ti-fw"></i> {{ i18n.ts.error }}</span
        >
        <span
    ...
    >
      ...
      <template #caption>
        ...
        <span v-if="passwordStrength == 'medium'" style="color: var(--warn)"
          ><i class="ti ti-check ti-fw"></i> {{ i18n.ts.normalPassword }}</span
        >
        <span v-if="passwordStrength == 'high'" style="color: var(--success)"
          ><i class="ti ti-check ti-fw"></i> {{ i18n.ts.strongPassword }}</span
        >
      </template>
    </MkInput>
    <MkInput
    ...
    >
      ...
      <template #caption>
        <span
          ...
          ><i class="ti ti-check ti-fw"></i> {{ i18n.ts.passwordMatched }}</span
        >
        <span
