<template>
  <div :class="$style.root">
    <template v-if="edit">
      ...
      >
        <template #item="{ element }">
          <div
            :class="[$style.widget, $style['customize-container']]"
            class="data-cy-customize-container"
          >
            <button
              :class="$style['customize-container-config']"
              class="_button"
            ...
            <button
              :class="$style['customize-container-remove']"
              class="_button data-cy-customize-container-remove"
            ...
            <div class="handle">
              <component
                ...
                class="widget"
                :class="$style['customize-container-handle-widget']"
                :widget="element"
                @update-props="updateWidget(element.id, $event)"
              />
            </div>
          </div>
        </template>
    ...
    <component
      ...
      :class="$style.widget"
      :widget="widget"
      @update-props="updateWidget(widget.id, $event)"
