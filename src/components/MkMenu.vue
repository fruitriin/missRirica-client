<template>
  <div>
    <div
      ...
      :class="[
        $style.root,
        { [$style.center]: align === 'center', [$style.asDrawer]: asDrawer },
      ]"
      :style="{
      ...
      <template v-for="(item, i) in items2">
        ...
        <button
          ...
          :class="[
            $style.item,
            $style.parent,
            { [$style.childShowing]: childShowingItem === item },
          ]"
        ...
        >
          ...
          <span :class="$style.caret"
            ><i class="ti ti-caret-right ti-fw"></i
          ></span>
        </button>
        <button
          v-else
          ...
          :class="[
            $style.item,
            { [$style.danger]: item.danger, [$style.active]: item.active },
          ]"
          :disabled="item.active"
          @click="clicked(item.action, $event)"
          @mouseenter.passive="onItemMouseEnter(item)"
