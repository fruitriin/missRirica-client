<template>
  <div class="_debobigegoItem">
    <div class="_debobigegoLabel">
      <i class="fas fa-microchip"></i> {{ $ts.cpuAndMemory }}
    </div>
        ...
        <div class="_table">
          <div class="_row">
            ...
            <div class="_cell">
              ...
              {{ bytes(memUsage) }} ({{
                ((memUsage / serverInfo.mem.total) * 100).toFixed(0)
              }}%)
            </div>
            <div class="_cell">
              ...
              {{ bytes(serverInfo.mem.total - memUsage) }} ({{
                (
                  ((serverInfo.mem.total - memUsage) / serverInfo.mem.total) *
                  100
                ).toFixed(0)
              }}%)
            </div>
          ...
          <div class="_row">
            ...
            <div class="_cell">
              ...
              {{ bytes(serverInfo.fs.used) }} ({{
                ((serverInfo.fs.used / serverInfo.fs.total) * 100).toFixed(0)
              }}%)
            </div>
            <div class="_cell">
              ...
              {{ bytes(serverInfo.fs.total - serverInfo.fs.used) }} ({{
                (
                  ((serverInfo.fs.total - serverInfo.fs.used) /
                    serverInfo.fs.total) *
                  100
                ).toFixed(0)
              }}%)
  ...
  <div class="_debobigegoItem">
    <div class="_debobigegoLabel">
      <i class="fas fa-exchange-alt"></i> {{ $ts.network }}
    </div>
    <div class="_debobigegoPanel xhexznfu">
      <div>
